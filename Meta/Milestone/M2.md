...
- [ ] End-to-end tests
  - [ ] Create character → verify in DB → verify in UI
  - [ ] Update world → verify changes persist
- [ ] Performance testing
...
### Unit Tests
- [ ] CharacterRepository CRUD tests
- [ ] WorldRepository CRUD tests
- [ ] RelationshipRepository tests
- [ ] StoryBibleService validation tests
...
### E2E Tests
- [ ] Create character via UI → verify in database
- [ ] CLI `bible list` → shows created characters
- [ ] Update world rules → verify in UI
