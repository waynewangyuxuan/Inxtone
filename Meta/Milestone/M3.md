...
- [ ] **AI Sidebar**
  ...
  - [ ] Context editing: toggle items on/off (L2-L5 可控, L1 始终包含)
  - [ ] Prompt input field
...
- [ ] **Story Bible Panel (Left)**
  - [ ] Auto-populate from chapter FK: characters[], locations[], foreshadowingHinted[]
...
- [x] API endpoints + Service layer (18 route tests)
